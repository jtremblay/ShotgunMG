...
workflow {
    ...
    */
    ...
    /*
        MAGs
    */
    METABAT_ABUNDANCE(BWAMEM_PE.out.bam.map{sample_id, file -> file}.collect())
    METABAT2(
        ch_assembly.collect(), 
